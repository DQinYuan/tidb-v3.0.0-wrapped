...
func (b *baseBuiltinFunc) PbCode() tipb.ScalarFuncSig {
	trace_util_0.Count(_builtin_00000, 0)
	return b.pbCode
}

func (b *baseBuiltinFunc) setPbCode(c tipb.ScalarFuncSig) {
	trace_util_0.Count(_builtin_00000, 1)
	b.pbCode = c
}

func newBaseBuiltinFunc(ctx sessionctx.Context, args []Expression) baseBuiltinFunc {
	trace_util_0.Count(_builtin_00000, 2)
	if ctx == nil {
		trace_util_0.Count(_builtin_00000, 4)
		panic("ctx should not be nil")
	}
	trace_util_0.Count(_builtin_00000, 3)
...
func newBaseBuiltinFuncWithTp(ctx sessionctx.Context, args []Expression, retType types.EvalType, argTps ...types.EvalType) (bf baseBuiltinFunc) {
	trace_util_0.Count(_builtin_00000, 5)
	if len(args) != len(argTps) {
		trace_util_0.Count(_builtin_00000, 11)
		panic("unexpected length of args and argTps")
	}
	trace_util_0.Count(_builtin_00000, 6)
	if ctx == nil {
		trace_util_0.Count(_builtin_00000, 12)
		panic("ctx should not be nil")
	}
	trace_util_0.Count(_builtin_00000, 7)
	for i := range args {
		trace_util_0.Count(_builtin_00000, 13)
		switch argTps[i] {
		case types.ETInt:
			trace_util_0.Count(_builtin_00000, 14)
			args[i] = WrapWithCastAsInt(ctx, args[i])
		case types.ETReal:
			trace_util_0.Count(_builtin_00000, 15)
			args[i] = WrapWithCastAsReal(ctx, args[i])
		case types.ETDecimal:
			trace_util_0.Count(_builtin_00000, 16)
			args[i] = WrapWithCastAsDecimal(ctx, args[i])
		case types.ETString:
			trace_util_0.Count(_builtin_00000, 17)
			args[i] = WrapWithCastAsString(ctx, args[i])
		case types.ETDatetime:
			trace_util_0.Count(_builtin_00000, 18)
			args[i] = WrapWithCastAsTime(ctx, args[i], types.NewFieldType(mysql.TypeDatetime))
		case types.ETTimestamp:
			trace_util_0.Count(_builtin_00000, 19)
			args[i] = WrapWithCastAsTime(ctx, args[i], types.NewFieldType(mysql.TypeTimestamp))
		case types.ETDuration:
			trace_util_0.Count(_builtin_00000, 20)
			args[i] = WrapWithCastAsDuration(ctx, args[i])
		case types.ETJson:
			trace_util_0.Count(_builtin_00000, 21)
			args[i] = WrapWithCastAsJSON(ctx, args[i])
		}
	}
	trace_util_0.Count(_builtin_00000, 8)
	var fieldType *types.FieldType
	switch retType {
	case types.ETInt:
		trace_util_0.Count(_builtin_00000, 22)
	...
	case types.ETReal:
		trace_util_0.Count(_builtin_00000, 23)
		fieldType = &types.FieldType{
			Tp:      mysql.TypeDouble,
	...
	case types.ETDecimal:
		trace_util_0.Count(_builtin_00000, 24)
		fieldType = &types.FieldType{
	...
	case types.ETString:
		trace_util_0.Count(_builtin_00000, 25)
		fieldType = &types.FieldType{
	...
	case types.ETDatetime:
		trace_util_0.Count(_builtin_00000, 26)
		fieldType = &types.FieldType{
	...
	case types.ETTimestamp:
		trace_util_0.Count(_builtin_00000, 27)
		fieldType = &types.FieldType{
	...
	case types.ETDuration:
		trace_util_0.Count(_builtin_00000, 28)
		fieldType = &types.FieldType{
	...
	case types.ETJson:
		trace_util_0.Count(_builtin_00000, 29)
		fieldType = &types.FieldType{
			Tp:      mysql.TypeJSON,
...
func (b *baseBuiltinFunc) evalDecimal(row chunk.Row) (*types.MyDecimal, bool, error) {
	trace_util_0.Count(_builtin_00000, 36)
...
func (b *baseBuiltinFunc) evalTime(row chunk.Row) (types.Time, bool, error) {
	trace_util_0.Count(_builtin_00000, 37)
...
func (b *baseBuiltinFunc) evalDuration(row chunk.Row) (types.Duration, bool, error) {
	trace_util_0.Count(_builtin_00000, 38)
...
func (b *baseBuiltinFunc) evalJSON(row chunk.Row) (json.BinaryJSON, bool, error) {
	trace_util_0.Count(_builtin_00000, 39)
	panic("baseBuiltinFunc.evalJSON() should never be called.")
}

func (b *baseBuiltinFunc) getRetTp() *types.FieldType {
	trace_util_0.Count(_builtin_00000, 40)
	switch b.tp.EvalType() {
	case types.ETString:
		trace_util_0.Count(_builtin_00000, 42)
		if b.tp.Flen >= mysql.MaxBlobWidth {
			trace_util_0.Count(_builtin_00000, 44)
			b.tp.Tp = mysql.TypeLongBlob
		} else {
			trace_util_0.Count(_builtin_00000, 45)
			if b.tp.Flen >= 65536 {
				trace_util_0.Count(_builtin_00000, 46)
				b.tp.Tp = mysql.TypeMediumBlob
			}
		}
		trace_util_0.Count(_builtin_00000, 43)
		if len(b.tp.Charset) <= 0 {
			trace_util_0.Count(_builtin_00000, 47)
			b.tp.Charset, b.tp.Collate = charset.GetDefaultCharsetAndCollate()
		}
	}
	trace_util_0.Count(_builtin_00000, 41)
	return b.tp
}

func (b *baseBuiltinFunc) equal(fun builtinFunc) bool {
	trace_util_0.Count(_builtin_00000, 48)
	funArgs := fun.getArgs()
	if len(funArgs) != len(b.args) {
		trace_util_0.Count(_builtin_00000, 51)
		return false
	}
	trace_util_0.Count(_builtin_00000, 49)
	for i := range b.args {
		trace_util_0.Count(_builtin_00000, 52)
		if !b.args[i].Equal(b.ctx, funArgs[i]) {
			trace_util_0.Count(_builtin_00000, 53)
			return false
		}
	}
	trace_util_0.Count(_builtin_00000, 50)
	return true
}

func (b *baseBuiltinFunc) getCtx() sessionctx.Context {
	trace_util_0.Count(_builtin_00000, 54)
	return b.ctx
}

func (b *baseBuiltinFunc) cloneFrom(from *baseBuiltinFunc) {
	trace_util_0.Count(_builtin_00000, 55)
	b.args = make([]Expression, 0, len(b.args))
	for _, arg := range from.args {
		trace_util_0.Count(_builtin_00000, 57)
		b.args = append(b.args, arg.Clone())
	}
	trace_util_0.Count(_builtin_00000, 56)
	b.ctx = from.ctx
	b.tp = from.tp
...
func (b *baseBuiltinFunc) Clone() builtinFunc {
	trace_util_0.Count(_builtin_00000, 58)
...
func (b *baseBuiltinCastFunc) cloneFrom(from *baseBuiltinCastFunc) {
	trace_util_0.Count(_builtin_00000, 59)
...
func newBaseBuiltinCastFunc(builtinFunc baseBuiltinFunc, inUnion bool) baseBuiltinCastFunc {
	trace_util_0.Count(_builtin_00000, 60)
...
func (b *baseFunctionClass) verifyArgs(args []Expression) error {
	trace_util_0.Count(_builtin_00000, 61)
	l := len(args)
	if l < b.minArgs || (b.maxArgs != -1 && l > b.maxArgs) {
		trace_util_0.Count(_builtin_00000, 63)
		return ErrIncorrectParameterCount.GenWithStackByArgs(b.funcName)
	}
	trace_util_0.Count(_builtin_00000, 62)
	return nil
}
...
var _builtin_00000 = "expression/builtin.go"
