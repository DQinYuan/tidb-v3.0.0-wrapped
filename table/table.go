...
func (s Slice) Len() int { trace_util_0.Count(_table_00000, 0); return len(s) }
...
func (s Slice) Swap(i, j int) { trace_util_0.Count(_table_00000, 2); s[i], s[j] = s[j], s[i] }
...
var _table_00000 = "table/table.go"
