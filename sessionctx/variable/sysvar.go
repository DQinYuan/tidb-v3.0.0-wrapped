...
func GetSysVar(name string) *SysVar {
	trace_util_0.Count(_sysvar_00000, 0)
...
func init() {
	trace_util_0.Count(_sysvar_00000, 1)
	SysVars = make(map[string]*SysVar)
	for _, v := range defaultSysVars {
		trace_util_0.Count(_sysvar_00000, 3)
		SysVars[v.Name] = v
	}
	trace_util_0.Count(_sysvar_00000, 2)
...
func BoolToIntStr(b bool) string {
	trace_util_0.Count(_sysvar_00000, 4)
	if b {
		trace_util_0.Count(_sysvar_00000, 6)
		return "1"
	}
	trace_util_0.Count(_sysvar_00000, 5)
	return "0"
}
...
func addSynonymsSysVariables(synonyms ...string) {
	trace_util_0.Count(_sysvar_00000, 7)
	for _, s := range synonyms {
		trace_util_0.Count(_sysvar_00000, 8)
		SynonymsSysVariables[s] = synonyms
	}
}

func initSynonymsSysVariables() {
	trace_util_0.Count(_sysvar_00000, 9)
...
var _sysvar_00000 = "sessionctx/variable/sysvar.go"
