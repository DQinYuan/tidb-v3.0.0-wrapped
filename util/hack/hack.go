...
func String(b []byte) (s MutableString) {
	trace_util_0.Count(_hack_00000, 0)
	if len(b) == 0 {
		trace_util_0.Count(_hack_00000, 2)
		return ""
	}
	trace_util_0.Count(_hack_00000, 1)
...
func Slice(s string) (b []byte) {
	trace_util_0.Count(_hack_00000, 3)
	pbytes := (*reflect.SliceHeader)(unsafe.Pointer(&b))
	pstring := (*reflect.StringHeader)(unsafe.Pointer(&s))
...
var _hack_00000 = "util/hack/hack.go"
