...
func (s Float64Set) Insert(val float64) {
	trace_util_0.Count(_float64_set_00000, 2)
	s[val] = struct{}{}
}

var _float64_set_00000 = "util/set/float64_set.go"
