...
func RetLabel(err error) string {
	trace_util_0.Count(_metrics_00000, 0)
	if err == nil {
		trace_util_0.Count(_metrics_00000, 2)
		return opSucc
	}
	trace_util_0.Count(_metrics_00000, 1)
	return opFailed
}

// RegisterMetrics registers the metrics which are ONLY used in TiDB server.
func RegisterMetrics() {
	trace_util_0.Count(_metrics_00000, 3)
...
var _metrics_00000 = "metrics/metrics.go"
