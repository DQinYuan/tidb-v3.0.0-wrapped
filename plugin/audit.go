...
func (c ConnectionEvent) String() string {
	trace_util_0.Count(_audit_00000, 0)
	switch c {
	case Connected:
		trace_util_0.Count(_audit_00000, 2)
		return "Connected"
	case Disconnect:
		trace_util_0.Count(_audit_00000, 3)
		return "Disconnect"
	case ChangeUser:
		trace_util_0.Count(_audit_00000, 4)
		return "ChangeUser"
	case PreAuth:
		trace_util_0.Count(_audit_00000, 5)
		return "PreAuth"
	}
	trace_util_0.Count(_audit_00000, 1)
	return ""
}
...
var _audit_00000 = "plugin/audit.go"
